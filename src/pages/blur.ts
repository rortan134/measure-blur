...
//     let stats = measureBlur(imageData);
...
Filters.sobelVectors = function (px) {
    ...
    var id = { width: vertical.width, height: vertical.height, data: this.getFloat32Array(vertical.width * vertical.height * 8) };
...
// let worker;
// let workerMessageId = 0; // Number.MIN_SAFE_INTEGER would be better,
...
function detectEdges(imageData) {
    ...
    sobelKernel = Filters.getFloat32Array([1, 0, -1, 2, 0, -2, 1, 0, -1]);
...
export function measureBlur(imageData) {
